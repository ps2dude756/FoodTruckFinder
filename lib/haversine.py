...
def great_circle_distance(longitude1, latitude1, longitude2, latitude2):
    return 2*RADIUS_OF_EARTH*math.asin(
        haversine_formula(longitude1, latitude1, longitude2, latitude2)**.5
    )

def haversine_formula(longitude1, latitude1, longitude2, latitude2):
